...
**LightProof je jednostavan alat za provjeru gramatike, tipografije i stila baziran na pravilnim izrazima (regular expression).** Ovaj dodatak omogućuje brzu, laganu i nativnu provjeru teksta izravno unutar programa LibreOffice Writer, prilagođenu svakodnevnim potrebama izvornih govornika hrvatskoga jezika.
